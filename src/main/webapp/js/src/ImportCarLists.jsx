class ImportCarLists extends React.Component {
    constructor(props){
        super(props);
    ...
    componentDidMount() {
        this.setState({listData: JSON.parse(jQuery("#importCarListData").val())});
    }
            ...
            <React.Fragment>
                    ...
                    {function(){
                        if(this.state.listData && this.state.listData.length > 0){
                            ...
                            return <li className="more"><a href="javascript:openSearchCar('search_car', 2);">더보기</a></li>;
                        }
                    }.call(this)}
...
ReactDOM.render(
    <ImportCarLists />,
    document.getElementById('importCarLists')
);
