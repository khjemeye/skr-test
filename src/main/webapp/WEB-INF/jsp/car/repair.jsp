...
<div class="container">
    <div style="padding:2rem 0 2rem 1.5rem">
        <iframe name="carCheckIframe" id="iframeDetail" src="${carCheckUrl}?cNo=${checkNum}" onload="ResizeFrame(this);" width="960" height="4800" frameborder="0" scrolling="no"></iframe>
    </div>
</div>